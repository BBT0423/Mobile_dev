...
import 'package:flutter_application_7/editform.dart';
      ...
      body: Consumer(
        builder: (context, test_provider provider, child) { 
          if(provider.bookDetail.length <=0){
            return Center(child: Text('ไม่มีรายการหนังสือ',style: TextStyle(fontSize: 20),),);
          } else{
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              onTap: () {
                ...
                settings: RouteSettings(arguments: provider.bookDetail[index])
                ));
              },
            );
          },
